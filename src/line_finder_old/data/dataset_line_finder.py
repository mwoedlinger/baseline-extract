...
class DatasetLineFinder(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        # "Crop" the corresponding baseline labels
        ...
        labels_exp = torch.cat([labels, torch.tensor([[-1.0, -1.0, -1.0]]*(self.max_bl_no-len(labels)))], dim=0)

        sample = {'image': self.transform_to_tensor(image),
                  'label': labels_exp,
